...
import com.java.zhangxinyuan.ui.SearchedNewsActivity;
...
public class SearchedNewsListAdapter extends RecyclerView.Adapter<SearchedNewsListAdapter.MyHolder> {
    private List<NewsInfo.DataDTO> mDataDTOList = new ArrayList<>();
    private SearchedNewsActivity mContext;
    private static final String TAG = "SearchedNewsListAdapter";

    public SearchedNewsListAdapter(SearchedNewsActivity context) {
